...
const SellerSetting = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('📤 [SELLER-SETTING] Enviando:', requestBody);
      
      // const result = await dispatch(createSellerData(requestBody));
      
      // if (result) {
      //   console.log('✅ [SELLER-SETTING] Guardado exitosamente');
      //   setSellerExists(true);
      //   setIsEditing(false);
      //   // La action ya muestra el toast de éxito
      // }
    } catch (error) {
      console.error('❌ [SELLER-SETTING] Error:', error);
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="mb-8 border-b pb-4">
        ...
        <p className="text-gray-600 mt-2">
          Configure los datos fiscales  para la facturación electrónica
        </p>
      </div>
